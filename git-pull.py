...
def input_parse():
    ...
    parser.add_argument("-p", "--push", action="store_true", dest="push", help="Also attempts to push repos after attempting to pull")
    parser.add_argument("-d", "--destination", nargs=1, dest="path", help="Full path to the directory program will run at")
    return parser
